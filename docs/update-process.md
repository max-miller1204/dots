...
| `~/.local/state/dots/update-terminal-status` | Out-of-band terminal sidecar written only after a complete, incomplete, failed-migration, or deliberately aborted pipeline. Hook and migration transcript text cannot forge completion. |
